...
<input name="url_registrar" id="url_registrar" type="hidden" value="<?php echo base_url('Ingreso/Registrar'); ?>" />
...
<div id="base"><!-- BEGIN BASE-->
	<div id="content"><!-- BEGIN CONTENT-->
                    ...
                    <div class="card-body"> <!--card-body -->
                    	...
                    	<div class="row">
							<div class="col-sm-6">
                                ...
                                <div class="form-group">
									<input type="number" step="any" class="form-control input-lg" id="numero_de_nota" name="numero_de_nota">
                    		...
                    		<div class="col-sm-6">
                            	...
                            	<div class="form-group">
									<input type="number" class="form-control input-lg" id="cantidad_de_productos" name="cantidad_de_productos">
                                ...
                                <div class="form-group">
								  <input type="date" class="form-control input-lg" id="fecha_de_la_nota" name="fecha_de_la_nota" >
									<label for="fecha_de_la_nota" style="font-size:14px; text-transform:uppercase; font-weight:bold">fecha de la nota</label>
								</div>
                                
                                <div class="form-group">
								  <input type="number" step="any" class="form-control input-lg" id="total_a_pagar" name="total_a_pagar" >
        ...
        <div id="div_registrar_datos">assss</div><!-- div_registrar_datos-->
